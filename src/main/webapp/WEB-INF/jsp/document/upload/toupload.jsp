    ...
    <SCRIPT type="text/javascript">
        ...
        function onClick(event, treeId, treeNode, clickFlag) {
            ...
            if( currentDir !="") {
                ...
                $('#renameFolderBtn').removeAttr("disabled");
...
//            }
        ...
        $(document).ready(function () {
            ...
            $("#deleteFolderBtn").bind("click", remove);
...
<form method="post" id="form1" action="/doc/upload" enctype="multipart/form-data">
    ...
    <div style="margin: 5px">
        <button id="addFolderBtn" class="btn btn-sm btn-primary" disabled="disabled">新建</button>
        <button id="renameFolderBtn" class="btn btn-sm btn-primary" disabled="disabled">重命名</button>
        <button id="deleteFolderBtn" class="btn btn-sm btn-primary" disabled="disabled">删除</button>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>This <a href="#" role="button" class="btn btn-default popover-test" title="A Title"
                           data-toggle="popover"
                           data-content="And here's some amazing content. It's very engaging. right?">button</a> should
                    trigger a popover on click.</p>
                ...
                <p>
                    ...
                    <a href="#" class="tooltip-test" title="Tooltip" data-placement="bottom" data-toggle="tooltip">that
