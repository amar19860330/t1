...
public class News implements Serializable //,RowMapper<News>
{
    /**
...
//        news.setEditorid(resultSet.getInt("editorid"));
//        news.setTitle(resultSet.getString("title"));
//        news.setContent(resultSet.getString("content"));
//        news.setSourceby(resultSet.getString("sourceby"));
//        news.setStarttime(resultSet.getDate("starttime"));
//        news.setLastedittime(resultSet.getDate("lastedittime"));
//        news.setReleasetime(resultSet.getDate("releasetime"));
//        return news;
//    }
